...
function renderAll() {
  ...
  const f = el('input', 'filter'); f.placeholder = 'Filter by title, agency, asset, status, code…'; f.setAttribute('aria-label', 'Filter opportunities'); f.type = 'search'; f.autocomplete = 'off';
  v.append(f);
